...
import com.sandersme.advent.model.ProbeLauncher


/**
 * * -- Day 17: Trick Shot --- You finally decode the Elves' message. HI, the
 *     message says. You continue searching for the sleigh keys.
 *
 ...
 * order:
 *
 * The probe's x position increases by its x velocity. The probe's y position
 * increases by its y velocity. Due to drag, the probe's x velocity changes by 1
 * toward the value 0; that is, it decreases by 1 if it is greater than 0,
 ...
 * initial x,y velocity values such that after any step, the probe's x position
 * is at least 20 and at most 30, and the probe's y position is at least -10 and
 * at most -5.
 *
 ...
 * ....................TTTTTTTTTTT
 * ....................TTTTTTTTTTT
 * ....................TTTTTTTTTTT In this diagram, S is the probe's initial
 *                     position, 0,0. The x coordinate increases to the right,
 *                     and the y coordinate increases upward. In the bottom
 *                     right, positions that are within the target area are
 *                     shown as T. After each step (until the target area is
 *                     reached), the position of the probe is marked with #.
 *                     (The bottom-right # is both a position the probe reaches
 ...
 * ....................TTTTTTTTTTT
 * ....................T#TTTTTTTTT
 * ....................TTTTTTTTTTT Another one is 9,0:
 *
 * S........#.....................
 * .................#.............
 * ...............................
 ...
 * ....................TTTTTTTTTTT
 * ....................TTTTTTTTTTT
 * ....................TTTTTTTTTTT One initial velocity that doesn't cause the
 *                     probe to be within the target area after any step is
 *                     17,-4:
 *
 * S..............................................................
 * ...............................................................
 ...
 * 8,-121,-9   6,2     20,-7   30,-10  14,-3 20,-8   13,-2   7,3     28,-8 29,-9
 * 15,-3   22,-5   26,-8   25,-8 25,-6   15,-4   9,-2    15,-2   12,-2   28,-9
 * 12,-3   24,-6   23,-7 25,-10  7,8     11,-3   26,-7   7,1     23,-9   6,0
 * 22,-10  27,-6 8,1     22,-8   13,-4   7,6     28,-6   11,-4   12,-4   26,-9 7,4
 * 24,-10  23,-8   30,-8   7,0     9,-1    10,-1   26,-5   22,-9   6,5 7,5 23,-6
 * 28,-10  10,-2   11,-1   20,-9   14,-2   29,-7   13,-3 23,-5   24,-8 27,-9 30,-7
 * 28,-5   21,-10  7,9     6,6     21,-5 27,-10  7,2     30,-9 21,-8   22,-7 24,-9
 * 20,-6   6,9     29,-5 8,-2    27,-8   30,-5   24,-7 How many distinct initial
 * velocity values cause the probe to be within the target area after any step?
 */
object TrickShot {
  def main(args: Array[String]): Unit = {
    ...
    println(probe)
    println(s"PART 1: The legal maxY is: ${maximumY}")

    println(s"PART 2: The number of legal targets with different starting" +
      s"velocities for {X} and {Y} are: ${probe.findAllPossibleProbes.size}")
  }
}
