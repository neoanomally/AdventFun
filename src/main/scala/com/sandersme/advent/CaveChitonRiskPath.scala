...
import com.sandersme.advent.model.ChitonPath
import com.sandersme.advent.model.ChitonPath.{ChitonRoute, findShortestRoute}

import scala.collection.mutable

object CaveChitonRiskPath {

  /**
   * 
   * --- Day 15: Chiton --- You've almost reached the exit of the cave, but the
   *     walls are getting closer together. Your submarine can barely still fit,
   *     though; the main problem is that the walls of the cave are covered in
   *     chitons, and it would be best not to bump any of them.
   *
   ...
   * input). For example:
   *
   * 1163751742 1381373672 2136511328 3694931569 7463417111 1319128137 1359912421
   * 3125421639 1293138521 2311944581 You start in the top left position, your
   * destination is the bottom right position, and you cannot move diagonally. The
   * number at each position is its risk level; to determine the total risk of an
   * entire path, add up the risk levels of each position you enter (that is,
   ...
   *
   * 1163751742 1381373672 2136511328 3694931569 7463417111 1319128137 1359912421
   * 3125421639 1293138521 2311944581 The total risk of this path is 40
