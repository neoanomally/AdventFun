...
object TreacheryOfWhales {
   ...
   * zooms in to rescue you! They seem to be preparing to blast a hole in the ocean floor; sensors indicate
   ...
   * for your submarine to get through. However, it doesn't look like they'll be aligned before the whale catches
   ...
   * limited fuel, so you need to find a way to make all of their horizontal positions match while requiring them
